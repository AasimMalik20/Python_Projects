...
#layout of calculator using tkinter
root = Tk()

#set the name on the top of the GUI
root.title("Scientific Calculator")
#set bg as #white
root.configure(background='white')

#make wd and ht of GUI non expandable
root.resizable(width=False, height=False)

#Set the geometry
root.geometry("480x568+450+90")

#holds the buttons in calc and acts as a container for numbers and opertors
calc = Frame(root)
#create buttons ~ grid like patterns
calc.grid()
...
##
##Creating NumberPAd for the Calculator

numberpad = "789456123"

#i  counts the rows for buttons in grid
i = 0
##creating an empty list to store
btn=[]
#creating j range
for j in range(2,5):
    #k stores the button in a particular column
    for k in range(3):
        ...
        #set the buttons in row and column seprating them with a padding of 1 unit
        ...
        #assinging numbers on the numberpad
...
#creating MenuBar for the Calculator
def iExit():
    ...
    if iExit>0:
        root.destroy()
        return
#Creating Scientific and Standard Menus/Options
def Scientific():
    root.resizable(width=False, height=False)
